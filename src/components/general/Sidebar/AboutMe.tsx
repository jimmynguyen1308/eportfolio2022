...
import { socialConst } from "../../../constants/profile.const"
...
export default function AboutMe() {
  ...
  return (
    <div className="sidebar aboutme">
      ...
      {isHomepage ? (
        <p>
          Wanna get parasocial? You can have a quickie on these three (not too
          personal though)
        </p>
      ) : (
        <p>
          My name is Nhat, but for those English speakers you can just call me
          James. I'm from Vietnam 🇻🇳 and currently I am living and working in
          Sydney, Australia 🇦🇺 as a frontend web developer.
        </p>
      )}
